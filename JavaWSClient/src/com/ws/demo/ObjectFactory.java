 ...
 * generated in the com.ws.demo package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorld_QNAME = new QName("http://demo.ws.com/", "getHelloWorld");
    private final static QName _GetHelloWorldResponse_QNAME = new QName("http://demo.ws.com/", "getHelloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ws.demo
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo.ws.com/", name = "getHelloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo.ws.com/", name = "getHelloWorldResponse")
