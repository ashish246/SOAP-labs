 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://demo.ws.com/", wsdlLocation = "http://localhost:8080/WebServiceExample/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://demo.ws.com/", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebServiceExample/hello?wsdl");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://demo.ws.com/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo.ws.com/", "HelloWorldPort"), HelloWorld.class, features);
    }
