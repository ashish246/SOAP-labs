 ...
 * 
 */
@WebServiceClient(name = "ServerInfoService", targetNamespace = "http://service.soap.com/", wsdlLocation = "http://localhost:8888/ws/server?wsdl")
...
public class ServerInfoService extends Service {
	...
	private final static QName SERVERINFOSERVICE_QNAME = new QName(
			"http://service.soap.com/", "ServerInfoService");
	...
	public ServerInfo getServerInfoPort() {
		return super.getPort(new QName("http://service.soap.com/",
				"ServerInfoPort"), ServerInfo.class);
	}
	...
	public ServerInfo getServerInfoPort(WebServiceFeature... features) {
		return super.getPort(new QName("http://service.soap.com/",
				"ServerInfoPort"), ServerInfo.class, features);
	}
