...
/**
 * Create a SOAP handler to inject client’s MAC address into the SOAP header
 * block, for every outgoing SOAP message.
 * 
 * @author Administrator
 *
 */
public class MyAddressInjectHandler implements SOAPHandler<SOAPMessageContext> {
